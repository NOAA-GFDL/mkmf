...
FPPFLAGS += $(shell pkg-config netcdf-fortran --cflags)
...
CPPFLAGS += $(shell pkg-config netcdf --cflags)
...
LIBS += $(shell pkg-config netcdf --libs) $(shell pkg-config netcdf-fortran --libs)
