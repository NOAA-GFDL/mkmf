...
FFLAGS := -Wl,-rpath,${NETCDF_DIR}/lib:${HDF5_DIR}/lib -fno-alias -auto -safe-cray-ptr -ftz -assume byterecl -i4 $(REAL_PRECISION) -nowarn -sox -traceback -qno-opt-dynamic-align
