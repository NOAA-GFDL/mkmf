# Template for the Intel Compilers on URSA System
#
# Typical use with mkmf
# mkmf -t ursa-intel-oneapi.mk -c"-Duse_libMPI -Duse_netCDF" path_names /usr/local/include
...
LIBS += $(shell nf-config --flibs | sed -e "s/-lnetcdf //g")
